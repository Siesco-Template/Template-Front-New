  ...
  function getBlockNote() {
    switch (reason) {
      ...
      case BlockReason.UntilDate:
        return (
          <>
            İstifadəçi hesabınız 10 uğursuz giriş cəhdinə görə təhlükəsizlik məqsədilə 24 saatlıq bloklanıb. Girişə 
  ...
  return (
    <div className='w-full flex flex-col items-center gap-[32px] !mt-[80px]'>
      ...
      <div className='w-full !p-[20px] bg-[#FFF] rounded-[16px] flex flex-col gap-[20px]'>
        <p className='w-full text-center text-[#05194AB3] leading-[21px]'>
          {getBlockNote()}
        </p>
