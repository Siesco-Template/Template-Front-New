...
export {
    Dialog as PanelDialog,
    DialogClose as PanelDialogClose,
    DialogContent as PanelDialogContent,
    DialogDescription as PanelDialogDescription,
    DialogFooter as PanelDialogFooter,
    DialogHeader as PanelDialogHeader,
    DialogOverlay as PanelDialogOverlay,
    DialogPortal as PanelDialogPortal,
    DialogTitle as PanelDialogTitle,
    DialogTrigger as PanelDialogTrigger,
};
